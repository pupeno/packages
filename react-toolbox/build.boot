...
(def +lib-version+ "2.0.0-beta.12")
(def +version+ (str +lib-version+ "-0"))
(def +lib-folder+ (format "react-toolbox-react-toolbox-%s" +lib-version+))
...
(deftask download-lib []
         (download :url (format "https://github.com/react-toolbox/react-toolbox/archive/react-toolbox@%s.zip" +lib-version+)
                   :checksum "8EB5308B6E7E639757AF4E8E4AD2DFEE"
                   :unzip true))
